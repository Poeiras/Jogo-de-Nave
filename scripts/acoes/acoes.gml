...
prox_arma = keyboard_check_released(ord("E")) || gamepad_button_check_released(0,gp_shoulderr);
ante_arma = keyboard_check_released(ord("Q")) || gamepad_button_check_released(0,gp_shoulderl);
